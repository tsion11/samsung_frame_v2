              ...
              <div className="row g-0 y-gap-48 row-dividers-dark">
                ...
                {/* <div className="col-lg-4 col-sm-6">
                  <div className="d-flex direction-column text-center px-48">
                    ...
                    <a className="text-16 fw-600 mt-20" href="#">
                      +(1) 123 456 7890
                    </a>
                    <a className="text-16 fw-600 mt-20" href="#">
                      hi@sassio.com
                    ...
                    <a
                      className="buttom -simple text-accent fw-600 mt-20"
                      href="#"
                    >
                      Open Google Map
                    </a>
              ...
              <div className="row justify-center text-center">
                <div className="col-auto">
                  <div className="sectionHeading ">
                    ...
                    <h2 className="sectionHeading__title">Tell us about </h2>
                  </div>
                </div>
              </div>
                ...
                <div className="col-sm-6">
                  <div className="d-flex direction-column text-center px-60 md:px-30">
                    ...
                    <p className="mt-16">
                      ...
                      your project? or want a demonstration? drop us a line to{" "}
