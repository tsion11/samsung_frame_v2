              ...
              <div className="row y-gap-60 items-center">
                          ...
                          >
                            <div className="ratio ratio-62:60">
                              <img
                                ...
                                src="/img/portfolio/cards/a1.jpg"
                                alt="project image"
                              />
                            </div>
                          </a>
                ...
                <div className="col-lg-6">
                  <div className="pl-40 pb-80 lg:pl-0 md:pb-0">
                    <h2 className="text-32 mt-4">The Desert</h2>
                    <div className="text-xl fw-600 text-accent mt-12">$100</div>
                    <div className="mt-30">
                      <p>
                        The landscapes are equally captivating, with vibrant
                        colors and imaginative designs that transport you to a
                                      ...
                                      <div className="comments__item-inner md:direction-column">
                                        ...
                                        <div className="comments__body md:mt-16">
                                          ...
                                          <div className="comments__text mt-10">
                                            <p>
                                              I can't believe this art is
                                              officially in my collection.
                                            </p>
                                          </div>
                                        </div>
                                      </div>
