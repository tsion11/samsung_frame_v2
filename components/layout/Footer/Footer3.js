            ...
            <div className="row y-gap-48 justify-content-between">
              <div className="col-lg-3 col-5">
                <div className="footer__item">
                  ...
                  <p className="mt-16">
                    Carefully crafted and powerful HTML5 template, it's perfect
                    to showcase your startup or software
                  </p>
              ...
              <div className="col-lg-2 col-5">
                <div className="footer__item">
                  ...
                  <div className="footer__content y-gap-10 mt-40">
                    ...
                    <div className="footer__content__item">
                      <Link className="decoration-none" href="/about/about-1">
                        About
                      </Link>
                    </div>
                    <div className="footer__content__item">
                    ...
                    <div className="footer__content__item">
                      <Link className="decoration-none" href="/shop-list">
                        Shop
                      </Link>
                    </div>
                    <div className="footer__content__item">
                    ...
                    <div className="footer__content__item">
                      <Link className="decoration-none" href="/pricing">
                        Pricing
                      </Link>
                    </div>
                    <div className="footer__content__item">
